...
potentie_export_rast     <- if(exists("speerwaterjuffer_leefgebied_max") && !all(is.na(terra::values(speerwaterjuffer_leefgebied_max, mat=FALSE)))) terra::ifel(!is.na(speerwaterjuffer_leefgebied_max) & speerwaterjuffer_leefgebied_max > 0, 1, NA) else terra::rast(template_TV, vals = NA)
werkelijk_export_rast    <- if(exists("speerwaterjuffer_leefgebied_opp") && !all(is.na(terra::values(speerwaterjuffer_leefgebied_opp, mat=FALSE)))) terra::ifel(!is.na(speerwaterjuffer_leefgebied_opp) & speerwaterjuffer_leefgebied_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
arpl_export_rast         <- if(exists("speerwaterjuffer_arpl_opp") && !all(is.na(terra::values(speerwaterjuffer_arpl_opp, mat=FALSE)))) terra::ifel(speerwaterjuffer_arpl_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
verspreiding_export_rast <- if(exists("speerwaterjuffer_verspr_opp") && !all(is.na(terra::values(speerwaterjuffer_verspr_opp, mat=FALSE)))) terra::ifel(speerwaterjuffer_verspr_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
...
```{r export}
# ==============================================================================
# 2. SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (SCENARIO SPEERWATERJUFFER)
# ==============================================================================
...
message("🏁 SCENARIO EXPORT VOLLEDIG AFGEROND VOOR SPEERWATERJUFFER!")
```
