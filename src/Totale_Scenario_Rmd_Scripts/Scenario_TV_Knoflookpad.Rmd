---
title: "Scenario Leefgebiedenscript: Knoflookpad"
...
potentie_export_rast     <- if(exists("knoflookpad_leefgebied_max") && !all(is.na(terra::values(knoflookpad_leefgebied_max, mat=FALSE)))) terra::ifel(!is.na(knoflookpad_leefgebied_max) & knoflookpad_leefgebied_max > 0, 1, NA) else terra::rast(template_TV, vals = NA)
werkelijk_export_rast    <- if(exists("knoflookpad_leefgebied_opp") && !all(is.na(terra::values(knoflookpad_leefgebied_opp, mat=FALSE)))) terra::ifel(!is.na(knoflookpad_leefgebied_opp) & knoflookpad_leefgebied_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
arpl_export_rast         <- if(exists("knoflookpad_arpl_opp") && !all(is.na(terra::values(knoflookpad_arpl_opp, mat=FALSE)))) terra::ifel(knoflookpad_arpl_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
verspreiding_export_rast <- if(exists("knoflookpad_verspreiding_bin") && !all(is.na(terra::values(knoflookpad_verspreiding_bin, mat=FALSE)))) terra::ifel(knoflookpad_verspreiding_bin > 0, 1, NA) else terra::rast(template_TV, vals = NA)
...
```{r export}
# ==============================================================================
# 2. SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (SCENARIO KNOFLOOKPAD)
# ==============================================================================
...
message("🏁 SCENARIO EXPORT VOLLEDIG AFGEROND VOOR KNOFLOOKPAD!")
```
