...
waarnemingen_path <- here("data/input/Territoria_Soorten/DM_Territoria_Roerdomp.csv")
...
# Binaire mal van De Maten ZONDER de buffer
...
message("-> Alle GeoTIFF exports voor de Roerdomp in De Maten zijn succesvol weggeschreven!")
```
