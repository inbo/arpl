...
# ==============================================================================
# SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (VENWITSNUITLIBEL - TURNHOUTS VENNEGEBIED)
# ==============================================================================
...
# 1. Maximale potentie
if (exists("venwitsnuitlibel_leefgebied_max") && !all(is.na(terra::values(venwitsnuitlibel_leefgebied_max, mat = FALSE)))) {
  potentie_export_rast <- terra::ifel(!is.na(venwitsnuitlibel_leefgebied_max) & venwitsnuitlibel_leefgebied_max > 0, 1, NA)
...
if (exists("venwitsnuitlibel_leefgebied_opp") && !all(is.na(terra::values(venwitsnuitlibel_leefgebied_opp, mat = FALSE)))) {
  werkelijk_export_rast <- terra::ifel(!is.na(venwitsnuitlibel_leefgebied_opp) & venwitsnuitlibel_leefgebied_opp > 0, 1, NA)
...
if (exists("venwitsnuitlibel_arpl_opp") && !all(is.na(terra::values(venwitsnuitlibel_arpl_opp, mat = FALSE)))) {
  arpl_export_rast <- terra::ifel(!is.na(venwitsnuitlibel_arpl_opp) & venwitsnuitlibel_arpl_opp > 0, 1, NA)
} else {
...
if (exists("venwitsnuitlibel_verspr_opp") && !all(is.na(terra::values(venwitsnuitlibel_verspr_opp, mat = FALSE)))) {
  verspreiding_export_rast <- terra::ifel(!is.na(venwitsnuitlibel_verspr_opp) & venwitsnuitlibel_verspr_opp > 0, 1, NA)
} else {
