...
venwitsnuitlibel_land_ruim_max <- template_DM * NA
...
venwitsnuitlibel_land_ruim_opp <- template_DM * NA
...
venwitsnuitlibel_leefgebied_max <- terra::crop(venwitsnuitlibel_leefgebied_max, template_DM)
...
venwitsnuitlibel_leefgebied_opp <- terra::crop(venwitsnuitlibel_leefgebied_opp, template_DM)
