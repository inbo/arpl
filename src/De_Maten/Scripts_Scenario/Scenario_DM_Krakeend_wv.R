...
# ==============================================================================
# STAP 2: WATERLOPEN INTEGREREN EN DIRECT LEEFGEBIED SAMENVOEGEN
# ==============================================================================
...
final_max <- krakeend_leefgebied_max
final_opp <- krakeend_leefgebied_opp
...
for(item in export_config) {
  suffix <- if ((exists("zoek_sleutel") && grepl("_wv$", zoek_sleutel)) || (exists("soort") && grepl("krakeend", soort, ignore.case = TRUE))) "_wv.tif" else ".tif"
