...
r_binair_opp <- terra::ifel(!is.na(bwk_opp) & bwk_opp > 0, 1, NA)
res_opp <- cluster_filter_compleet(r_binair_opp, bwk_opp, drempel_m2, afstand_m, werkelijk = TRUE)
...
# Statusraster opbouwen op basis van de gecorrigeerde en ontkoppelde lagen
