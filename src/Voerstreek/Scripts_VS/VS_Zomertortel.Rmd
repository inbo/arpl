...
waarnemingen_path <- here("data/input/Territoria_Soorten/VS_Territoria_Zomertortel.csv")
...
map_diag %>%
  ...
  addPolygons(data = grens_web, fill = FALSE, color = "black", weight = 3, group = "Grens VS") %>%
  addLayersControl(
