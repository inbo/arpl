...
waarnemingen_path <- here("data/input/Territoria_Soorten/TV_Territoria_ZwarteSpecht.csv")
...
# Maak een binaire mal van het Turnhouts_Vennegebied ZONDER de buffer
...
if (!all(is.na(terra::values(cl_max, mat=FALSE)))) {
  ...
  # 3. Welke clusters raken het Turnhouts_Vennegebied
