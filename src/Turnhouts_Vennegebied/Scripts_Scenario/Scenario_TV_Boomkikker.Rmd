...
werkelijk_export_rast    <- if(!all(is.na(terra::values(boomkikker_leefgebied_opp, mat=FALSE)))) terra::ifel(!is.na(boomkikker_leefgebied_opp) & boomkikker_leefgebied_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
