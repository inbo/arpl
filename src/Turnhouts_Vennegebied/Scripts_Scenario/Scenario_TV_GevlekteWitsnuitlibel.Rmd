...
potentie_export_rast     <- if(exists("leefgebied_max") && !all(is.na(terra::values(leefgebied_max, mat=FALSE)))) terra::ifel(!is.na(leefgebied_max) & leefgebied_max > 0, 1, NA) else terra::rast(template_TV, vals = NA)
werkelijk_export_rast    <- if(exists("leefgebied_opp") && !all(is.na(terra::values(leefgebied_opp, mat=FALSE)))) terra::ifel(!is.na(leefgebied_opp) & leefgebied_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
