---
title: "Scenario Leefgebiedenscript: Middelstebontespecht"
...
```{r Cluster}
# ==============================================================================
# CLUSTER-ANALYSE OP WERKLIJKE OPPERVLAKTE (Spoor B)
# ==============================================================================
drempel_m2 <- oppervlakte_ha * 10000

if (!is.null(bwk_opp) && !all(is.na(terra::values(bwk_opp, mat = FALSE)))) {
  r_binair <- terra::ifel(!is.na(bwk_opp) & bwk_opp > 0, 1, NA)
...
cat("\n--- AUDIT: SCENARIO LEEFGEBIED MIDDELSTE BONTE SPECHT (WERKELIJKE OPPERVLAKTE) ---\n")
ha_opp_na <- calc_ha_exact(final_opp)
cat("Werkelijke oppervlakte leefgebied Middelste Bonte Specht in scenario:", round(ha_opp_na, 2), "ha\n")
