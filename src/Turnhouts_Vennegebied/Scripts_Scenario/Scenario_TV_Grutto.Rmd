...
# Bewaar tabel_vlaanderen voor bebouwingsfilter in Stap 4
tabel_vlaanderen_bebouw <- copy(tabel_vlaanderen)
...
# Formatteer de 4 rasters naar binaire 1/NA kaarten op basis van het Totaal Leefgebied
...
if(!is.null(resB_strikt) && (!all(is.na(terra::values(resB_strikt$kern, mat=FALSE))) \vert{}\vert{} !all(is.na(terra::values(resB_strikt$bouw, mat=FALSE))))) {
  r_net_totaal_opp <- terra::cover(resB_strikt$kern, resB_strikt$bouw)
  werkelijk_export_rast <- terra::ifel(!is.na(r_net_totaal_opp) & r_net_totaal_opp > 0, 1, NA)
} else {
