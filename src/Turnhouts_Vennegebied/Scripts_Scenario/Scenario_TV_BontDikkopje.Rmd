---
title: "Scenario Leefgebiedenscript: Bont dikkopje"
...
```{r export}
# Exporteer alle 4 de kaarten naar de gespecificeerde scenariomappen
...
# Formatteer rasters naar binaire 1/NA kaarten
...
# Dynamische HTS check voor de vergelijkingskaart
...
# Bepaal welk scenario-raster en referentie-raster we vergelijken
if (is_hts_exclusief) {
  ...
  message("-> Soort is NIET HTS-exclusief: Vergelijking gebeurt op basis van Werkelijke Oppervlakte.")
  r_scen <- werkelijk_export_rast
  ref_folder <- "02_Werkelijke_Oppervlakte"
  ref_prefix <- "Habitat_Werkelijke_Oppervlaktes_"
}

# Zoek het referentiebestand op (inclusief check op _wv suffix)
...
# Verschilmatrix: 1 = Verloren (Rood), 2 = Nieuw (Groen), 3 = Behouden (Blauw)
...
type_label <- if (is_hts_exclusief) "ARPL (HTS-exclusief)" else "Werkelijke Oppervlakte"
