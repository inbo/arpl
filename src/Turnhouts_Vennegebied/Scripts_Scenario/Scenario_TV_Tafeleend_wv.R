...
# ==============================================================================
# STAP 2: TAFELEEND - WATERLOPEN INTEGREREN (EXACTE CODES), FUZZY CLUSTERING (5 HA - PARALLEL)
# ==============================================================================
...
tafeleend_clusters_max <- cluster_filter_compleet(
...
r_foer_5ha_max <- tafeleend_clusters_max$raster
...
tafeleend_clusters_opp <- cluster_filter_compleet(
...
r_foer_5ha_opp <- tafeleend_clusters_opp$raster

message("-> Intersectie: Alleen geschikt habitat BINNEN de gereserveerde watervogelgebieden...")
tafeleend_leefgebied_max <- terra::mask(r_foer_5ha_max, r_watervogelgebied_max) %>% terra::crop(template_TV)
tafeleend_leefgebied_opp <- terra::mask(r_foer_5ha_opp, r_watervogelgebied_max) %>% terra::crop(template_TV)

message("--- TAFELEEND MODEL SUCCESVOL AFGEROND ---")
cat("Totaal stabiel leefgebied Tafeleend (ha):", round(calc_ha_exact(tafeleend_leefgebied_opp), 2), "\n")

rm(r_huetzon_raw, r_huetzon, huetzon_cats, ids_waterlopen_ok, r_waterlopen, r_waterlopen_opp, 
   foerageer_compleet_max, foerageer_compleet_opp, r_binair_foer_opp, tafeleend_clusters_max, tafeleend_clusters_opp)
gc()
