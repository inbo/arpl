...
krakeend_leefgebied_max <- terra::mask(r_foer_max, r_watervogelgebied_max) %>% terra::crop(template_TV)
krakeend_leefgebied_opp <- terra::mask(r_foer_opp, r_watervogelgebied_max) %>% terra::crop(template_TV)
