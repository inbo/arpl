...
rm(tabel_bebouw_HB, tabel_bebouw_som, tabel_bebouw_mapping, r_bebouwing_raw, res_bebouw_groot, r_bebouw_groot, vertaal_df, tabel_vlaanderen)
gc()
...
final_max <- zomertortel_leefgebied_max %>% terra::crop(template_HB)
final_opp <- zomertortel_leefgebied_opp %>% terra::crop(template_HB)
