...
if (length(lijst_matches) == 0 || length(lijst_oppervlaktes) == 0) {
  ...
  masker_bron <- template_HB * NA
  opp_bron    <- template_HB * NA
} else {
...
# 2. Evalueer de werkelijke oppervlakte binnen de cl_max clusters (indien aanwezig)
