...
zompsprinkhaan_leefgebied_max <- terra::crop(zompsprinkhaan_leefgebied_max, template_HB)
...
zompsprinkhaan_leefgebied_opp <- terra::ifel(som_cl > 0, som_cl, NA) %>% terra::crop(template_HB)

# DEFINITIEVE MODELUITGANGEN
final_max <- zompsprinkhaan_leefgebied_max
final_opp <- zompsprinkhaan_leefgebied_opp
