...
# --- SPOOR 2: WERKELIJKE OPPERVLAKTE (FRACTIONEEL) ---
paapje_leefgebied1_opp <- terra::mask(bwk_opp, geschikt_buiten_bosrand)

rm(afstand_tot_bos, geschikt_buiten_bosrand, paapje_bos)
gc()

# === STAP 3: CLUSTERING EN MINIMALE OPPERVLAKTE (5 HA) =======================
message("=== STAP 3: Clustering en Minimale Oppervlakte (5 ha) ===")
