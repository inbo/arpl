...
```{r export}
# ==============================================================================
# SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (ZOMERTORTEL - TURNHOUTS VENNEGEBIED)
# ==============================================================================
...
} else if (exists("zomertortel_leefgebied_max") && !all(is.na(terra::values(zomertortel_leefgebied_max, mat = FALSE)))) {
  potentie_export_rast <- terra::ifel(!is.na(zomertortel_leefgebied_max) & zomertortel_leefgebied_max > 0, 1, NA)
} else {
...
} else if (exists("zomertortel_leefgebied_opp") && !all(is.na(terra::values(zomertortel_leefgebied_opp, mat = FALSE)))) {
  werkelijk_export_rast <- terra::ifel(!is.na(zomertortel_leefgebied_opp) & zomertortel_leefgebied_opp > 0, 1, NA)
} else {
...
message("🏁 SCRIPT EN EXPORT VOLLEDIG EN SUCCESVOL AFGEROND VOOR ZOMERTORTEL!")
```
