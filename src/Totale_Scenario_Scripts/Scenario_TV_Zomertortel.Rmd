---
title: "Scenario Leefgebiedenscript: Zomertortel"
...
# FAILSAFE: Heropbouw vertaal_df en tabel_vlaanderen indien deze ontbreken
if (!exists("vertaal_df") || !exists("tabel_vlaanderen")) {
  tabel_vlaanderen <- readRDS(scenario_path)
  setDT(tabel_vlaanderen)
  tabel_vlaanderen[, CODE := tolower(trimws(CODE))]
...
# Nu pas veilig opruimen
rm(tabel_bebouw_TV, tabel_bebouw_som, tabel_bebouw_mapping, r_bebouwing_raw, res_bebouw_groot, r_bebouw_groot, vertaal_df)
gc()
```
...
```{r export}
# ==============================================================================
# 2. SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (SCENARIO ZOMERTORTEL)
# ==============================================================================
...
message("🏁 SCENARIO EXPORT VOLLEDIG AFGEROND VOOR ZOMERTORTEL!")
```
