---
title: "Scenario Leefgebiedenscript: Venwitsnuitlibel"
...
arpl_export_rast         <- if(exists("venwitsnuitlibel_arpl_opp") && !all(is.na(terra::values(venwitsnuitlibel_arpl_opp, mat=FALSE)))) terra::ifel(venwitsnuitlibel_arpl_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
verspreiding_export_rast <- if(exists("venwitsnuitlibel_verspr_opp") && !all(is.na(terra::values(venwitsnuitlibel_verspr_opp, mat=FALSE)))) terra::ifel(venwitsnuitlibel_verspr_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
