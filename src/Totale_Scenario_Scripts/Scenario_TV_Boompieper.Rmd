...
potentie_export_rast     <- if(exists("leefgebied_finaal_max_binair") && !all(is.na(terra::values(leefgebied_finaal_max_binair, mat=FALSE)))) terra::ifel(!is.na(leefgebied_finaal_max_binair) & leefgebied_finaal_max_binair > 0, 1, NA) else terra::rast(template_TV, vals = NA)
werkelijk_export_rast    <- if(exists("leefgebied_finaal_opp") && !all(is.na(terra::values(leefgebied_finaal_opp, mat=FALSE)))) terra::ifel(!is.na(leefgebied_finaal_opp) & leefgebied_finaal_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
...
verspreiding_export_rast <- if(exists("boompieper_verspreiding_bin") && !all(is.na(terra::values(boompieper_verspreiding_bin, mat=FALSE)))) terra::ifel(boompieper_verspreiding_bin > 0, 1, NA) else terra::rast(template_TV, vals = NA)
