---
title: "Scenario Leefgebiedenscript: Zwarte heidelibel"
...
potentie_export_rast     <- if(exists("finaal_max_binair") && !all(is.na(terra::values(finaal_max_binair, mat=FALSE)))) terra::ifel(!is.na(finaal_max_binair) & finaal_max_binair > 0, 1, NA) else if(exists("zwarteheidelibel_leefgebied_max") && !all(is.na(terra::values(zwarteheidelibel_leefgebied_max, mat=FALSE)))) terra::ifel(!is.na(zwarteheidelibel_leefgebied_max) & zwarteheidelibel_leefgebied_max > 0, 1, NA) else terra::rast(template_TV, vals = NA)
werkelijk_export_rast    <- if(exists("finaal_opp_binair") && !all(is.na(terra::values(finaal_opp_binair, mat=FALSE)))) terra::ifel(!is.na(finaal_opp_binair) & finaal_opp_binair > 0, 1, NA) else if(exists("zwarteheidelibel_leefgebied_opp") && !all(is.na(terra::values(zwarteheidelibel_leefgebied_opp, mat=FALSE)))) terra::ifel(!is.na(zwarteheidelibel_leefgebied_opp) & zwarteheidelibel_leefgebied_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
arpl_export_rast         <- if(exists("zwarteheidelibel_arpl_opp") && !all(is.na(terra::values(zwarteheidelibel_arpl_opp, mat=FALSE)))) terra::ifel(zwarteheidelibel_arpl_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
verspreiding_export_rast <- if(exists("zwarteheidelibel_verspr_opp") && !all(is.na(terra::values(zwarteheidelibel_verspr_opp, mat=FALSE)))) terra::ifel(zwarteheidelibel_verspr_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
...
```{r export}
# ==============================================================================
# 2. SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (SCENARIO ZWARTE HEIDELIBEL)
# ==============================================================================
...
message("🏁 SCENARIO EXPORT VOLLEDIG AFGEROND VOOR ZWARTE HEIDELIBEL!")
```
