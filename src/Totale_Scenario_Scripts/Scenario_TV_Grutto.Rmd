...
# BEHOUD tabel_vlaanderen VOOR LATER GEBRUIK (Bebouwingsfilter)
...
# FAILSAFE: Zorg dat tabel_vlaanderen geladen is als deze door een eerdere stap ontbreekt
...
# 6. SCHOONMAAK VAN HET GEHEUGEN (tabel_vlaanderen niet verwijderen!)
...
werkelijk_export_rast    <- if(!is.null(resB_strikt) && (!all(is.na(terra::values(resB_strikt$kern, mat=FALSE))) || !all(is.na(terra::values(resB_strikt$bouw, mat=FALSE))))) terra::ifel(!is.na(terra::cover(resB_strikt$kern, resB_strikt$bouw)) & terra::cover(resB_strikt$kern, resB_strikt$bouw) > 0, 1, NA) else terra::rast(template_TV, vals = NA)
...
```{r export}
# ==============================================================================
# 2. SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (SCENARIO GRUTTO)
# ==============================================================================
...
message("🏁 SCENARIO EXPORT VOLLEDIG AFGEROND VOOR GRUTTO!")
```
