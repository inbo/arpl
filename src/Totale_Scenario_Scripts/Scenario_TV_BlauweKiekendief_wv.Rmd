---
title: "Scenario Leefgebiedenscript: Blauwe Kiekendief (wintervogel)"
...
potentie_export_rast     <- if(exists("kiekendief_leefgebied_max") && !all(is.na(terra::values(kiekendief_leefgebied_max, mat=FALSE)))) terra::ifel(!is.na(kiekendief_leefgebied_max) & kiekendief_leefgebied_max > 0, 1, NA) else terra::rast(template_TV, vals = NA)
werkelijk_export_rast    <- if(exists("kiekendief_leefgebied_opp") && !all(is.na(terra::values(kiekendief_leefgebied_opp, mat=FALSE)))) terra::ifel(!is.na(kiekendief_leefgebied_opp) & kiekendief_leefgebied_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
arpl_export_rast         <- if(exists("kiekendief_arpl_opp") && !all(is.na(terra::values(kiekendief_arpl_opp, mat=FALSE)))) terra::ifel(kiekendief_arpl_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
verspreiding_export_rast <- if(exists("kiekendief_verspreiding_bin") && !all(is.na(terra::values(kiekendief_verspreiding_bin, mat=FALSE)))) terra::ifel(kiekendief_verspreiding_bin > 0, 1, NA) else terra::rast(template_TV, vals = NA)
