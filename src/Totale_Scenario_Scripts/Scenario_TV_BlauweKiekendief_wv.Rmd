...
# BEHOUD tabel_vlaanderen EN vertaal_df VOOR VERVOLGSTAPPEN
...
# FAILSAFE: Herinlezen indien tabel_vlaanderen of vertaal_df toch ontbreekt
...
# Geheugen opschonen zonder tabel_vlaanderen/vertaal_df te slopen
rm(tabel_bebouw_TV, tabel_bebouw_som, tabel_bebouw_mapping, r_bebouwing_raw, res_bebouw_groot, r_bebouw_groot)
gc()
```
...
```{r export}
# ==============================================================================
# 2. SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (SCENARIO BLAUWE KIEKENDIEF WV)
# ==============================================================================
...
message("🏁 SCENARIO EXPORT VOLLEDIG AFGEROND VOOR BLAUWE KIEKENDIEF (WV)!")
```
