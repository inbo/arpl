---
title: "Scenario Leefgebiedenscript: Noordse witsnuitlibel"
...
arpl_export_rast         <- if(exists("noordsewitsnuitlibel_arpl_opp") && !all(is.na(terra::values(noordsewitsnuitlibel_arpl_opp, mat=FALSE)))) terra::ifel(noordsewitsnuitlibel_arpl_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
verspreiding_export_rast <- if(exists("noordsewitsnuitlibel_verspr_opp") && !all(is.na(terra::values(noordsewitsnuitlibel_verspr_opp, mat=FALSE)))) terra::ifel(noordsewitsnuitlibel_verspr_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
