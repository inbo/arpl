...
potentie_export_rast     <- if(exists("boomkikker_leefgebied_max") && !all(is.na(terra::values(boomkikker_leefgebied_max, mat=FALSE)))) terra::ifel(!is.na(boomkikker_leefgebied_max) & boomkikker_leefgebied_max > 0, 1, NA) else terra::rast(template_TV, vals = NA)
werkelijk_export_rast    <- if(exists("boomkikker_leefgebied_opp") && !all(is.na(terra::values(boomkikker_leefgebied_opp, mat=FALSE)))) terra::ifel(!is.na(boomkikker_leefgebied_opp) & boomkikker_leefgebied_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
arpl_export_rast         <- if(exists("boomkikker_arpl_opp") && !all(is.na(terra::values(boomkikker_arpl_opp, mat=FALSE)))) terra::ifel(boomkikker_arpl_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
verspreiding_export_rast <- if(exists("boomkikker_verspreiding_bin") && !all(is.na(terra::values(boomkikker_verspreiding_bin, mat=FALSE)))) terra::ifel(boomkikker_verspreiding_bin > 0, 1, NA) else terra::rast(template_TV, vals = NA)
