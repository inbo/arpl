---
title: "Scenario Leefgebiedenscript: Zompsprinkhaan"
...
potentie_export_rast     <- if(exists("zompsprinkhaan_leefgebied_max") && !all(is.na(terra::values(zompsprinkhaan_leefgebied_max, mat=FALSE)))) terra::ifel(!is.na(zompsprinkhaan_leefgebied_max) & zompsprinkhaan_leefgebied_max > 0, 1, NA) else terra::rast(template_TV, vals = NA)
werkelijk_export_rast    <- if(exists("zompsprinkhaan_leefgebied_opp") && !all(is.na(terra::values(zompsprinkhaan_leefgebied_opp, mat=FALSE)))) terra::ifel(!is.na(zompsprinkhaan_leefgebied_opp) & zompsprinkhaan_leefgebied_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
arpl_export_rast         <- if(exists("zompsprinkhaan_arpl_opp") && !all(is.na(terra::values(zompsprinkhaan_arpl_opp, mat=FALSE)))) terra::ifel(zompsprinkhaan_arpl_opp > 0, 1, NA) else terra::rast(template_TV, vals = NA)
verspreiding_export_rast <- if(exists("zompsprinkhaan_verspreiding_bin") && !all(is.na(terra::values(zompsprinkhaan_verspreiding_bin, mat=FALSE)))) terra::ifel(zompsprinkhaan_verspreiding_bin > 0, 1, NA) else terra::rast(template_TV, vals = NA)
...
```{r export}
# ==============================================================================
# 2. SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (SCENARIO ZOMPSPRINKHAAN)
# ==============================================================================
...
message("🏁 SCENARIO EXPORT VOLLEDIG AFGEROND VOOR ZOMPSPRINKHAAN!")
```
