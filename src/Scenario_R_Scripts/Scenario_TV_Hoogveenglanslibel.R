...
# ==============================================================================
# BOSPATCHES EN BOSPERCENTAGES PER CLUSTER (MIN 60% BOS)
# ==============================================================================
...
if (!all(is.na(suppressWarnings(terra::minmax(cl_id_land_max))))) {
...
if (!all(is.na(suppressWarnings(terra::minmax(cl_id_land_opp))))) {
...
# ==============================================================================
# WATER-FIRST LANDBIOTOOP FILTERING (500M AFSNIJDING)
# ==============================================================================
...
if (exists("waterbiotoop_clusters_max") && !is.null(waterbiotoop_clusters_max$raster) &&
    !all(is.na(suppressWarnings(terra::minmax(waterbiotoop_clusters_max$raster))))) {
...
if (exists("waterbiotoop_clusters_opp") && !is.null(waterbiotoop_clusters_opp$raster) &&
    !all(is.na(suppressWarnings(terra::minmax(waterbiotoop_clusters_opp$raster))))) {
...
# ==============================================================================
# COMBINATIE 3: RUIME OMGEVING EN FINALE SAMENSMELTING
# ==============================================================================
