...
rm(biotoop_max, biotoop_opp_som, biotoop_opp_raw, biotoop_opp, groenkaart, groenkaart_TV, hooggroen_aligned, 
   r_bos_bin, r_estuarium, stoorlaag, tabel_estuarium, tabel_estuarium_TV, clean_opp, vertaal_df, lijst_matches, lijst_oppervlaktes, tabel_vlaanderen, resultaten_gegroepeerd, df_nieuw)
gc()
