...
zadelsprinkhaan_leefgebied_max <- terra::crop(zadelsprinkhaan_leefgebied_max, template_TV)
...
zadelsprinkhaan_leefgebied_opp <- terra::ifel(som_cl > 0, som_cl, NA) %>% terra::crop(template_TV)
