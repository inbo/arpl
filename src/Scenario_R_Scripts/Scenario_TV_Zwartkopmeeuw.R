...
if (!all(is.na(suppressWarnings(terra::minmax(r_voort_30ha_max))))) {
  if (!all(is.na(suppressWarnings(terra::minmax(r_water_2ha_max))))) {
...
if (!all(is.na(suppressWarnings(terra::minmax(r_voort_30ha_opp))))) {
  if (!all(is.na(suppressWarnings(terra::minmax(r_water_2ha_opp))))) {
...
if (!all(is.na(suppressWarnings(terra::minmax(r_voort_vlakbij_water_max))))) {
  if (!all(is.na(suppressWarnings(terra::minmax(r_foer_200ha_max))))) {
...
if (!all(is.na(suppressWarnings(terra::minmax(r_voort_vlakbij_water_opp))))) {
  if (!all(is.na(suppressWarnings(terra::minmax(r_foer_200ha_opp))))) {
