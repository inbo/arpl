...
```{r export}
# ==============================================================================
# SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (SPEERWATERJUFFER - TURNHOUTS VENNEGEBIED)
# ==============================================================================
...
# 1. Maximale potentie
if (exists("speerwaterjuffer_leefgebied_max") && !all(is.na(terra::values(speerwaterjuffer_leefgebied_max, mat = FALSE)))) {
...
if (exists("speerwaterjuffer_leefgebied_opp") && !all(is.na(terra::values(speerwaterjuffer_leefgebied_opp, mat = FALSE)))) {
...
if (exists("speerwaterjuffer_arpl_opp") && !all(is.na(terra::values(speerwaterjuffer_arpl_opp, mat = FALSE)))) {
  arpl_export_rast <- terra::ifel(!is.na(speerwaterjuffer_arpl_opp) & speerwaterjuffer_arpl_opp > 0, 1, NA)
} else {
...
if (exists("speerwaterjuffer_verspr_opp") && !all(is.na(terra::values(speerwaterjuffer_verspr_opp, mat = FALSE)))) {
  verspreiding_export_rast <- terra::ifel(!is.na(speerwaterjuffer_verspr_opp) & speerwaterjuffer_verspr_opp > 0, 1, NA)
} else {
