...
waarnemingen_path <- here("data/input/Territoria_Soorten/TV_Territoria_Roerdomp.csv")
...
# Binaire mal van Turnhouts Vennegebied ZONDER de buffer
...
if (!all(is.na(terra::values(cl_max, mat=FALSE)))) {
  ...
  # 4. FILTERING OP MINIMAAL HABITAT (25 ha drempel via oppervlakte_ha)
...
```{r export}
# ==============================================================================
# SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (ROERDOMP - TURNHOUTS VENNEGEBIED)
# ==============================================================================
...
message("-> Alle GeoTIFF exports voor de Roerdomp in Turnhouts Vennegebied zijn succesvol weggeschreven!")
```
