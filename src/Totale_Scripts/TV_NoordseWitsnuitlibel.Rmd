...
# ==============================================================================
# SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (NOORDSE WITSNUITLIBEL - TURNHOUTS VENNEGEBIED)
# ==============================================================================
...
if (exists("noordsewitsnuitlibel_arpl_opp") && !all(is.na(terra::values(noordsewitsnuitlibel_arpl_opp, mat = FALSE)))) {
  arpl_export_rast <- terra::ifel(!is.na(noordsewitsnuitlibel_arpl_opp) & noordsewitsnuitlibel_arpl_opp > 0, 1, NA)
} else {
...
if (exists("noordsewitsnuitlibel_verspr_opp") && !all(is.na(terra::values(noordsewitsnuitlibel_verspr_opp, mat = FALSE)))) {
  verspreiding_export_rast <- terra::ifel(!is.na(noordsewitsnuitlibel_verspr_opp) & noordsewitsnuitlibel_verspr_opp > 0, 1, NA)
} else {
...
message("🏁 SCRIPT EN EXPORT VOLLEDIG EN SUCCESVOL AFGEROND VOOR NOORDSE WITSNUITLIBEL!")
```
