...
# 3. Stel het pad in naar de gefilterde territoria-CSV
# (Pas de map 'output_territoria' aan als je de bestanden in een andere map hebt opgeslagen)
waarnemingen_path <- here("data/input/Territoria_Soorten/TV_Territoria_Boompieper.csv")

if (file.exists(waarnemingen_path)) {
  # Python heeft de CSV's geëxporteerd met standaard komma's (read_csv)
  waarnemingen_raw <- read_csv(waarnemingen_path, show_col_types = FALSE)
  
  if (nrow(waarnemingen_raw) > 0) {
    ...
    # Smear (dispersiebuffer) en blobs maken
...
```{r, export}
# ==============================================================================
# EXPORT MET KOGELVRIJE NUL-OPVULLING (BOOMPIEPER)
# ==============================================================================
...
# ==============================================================================
# STAP 8: INTERACTIEVE KAART (LEAFLET - MET SPREIDING GROOT VS KLEIN)
# ==============================================================================
if (exists("r_net_ids_tv") && !all(is.na(terra::values(r_net_ids_tv, mat=FALSE)))) {
