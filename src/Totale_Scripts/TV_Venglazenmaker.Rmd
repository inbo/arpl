...
if (exists("cl_id_opp") && !all(is.na(terra::values(cl_id_opp, mat=FALSE)))) {
  ...
  message("-> Leaflet-kaart opbouwen voor Venglazenmaker...")
...
# ==============================================================================
# SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (VENGLAZENMAKER - TURNHOUTS VENNEGEBIED)
# ==============================================================================
...
# 1. Maximale potentie
if (exists("venglazenmaker_leefgebied_max") && !all(is.na(terra::values(venglazenmaker_leefgebied_max, mat = FALSE)))) {
  potentie_export_rast <- terra::ifel(!is.na(venglazenmaker_leefgebied_max) & venglazenmaker_leefgebied_max > 0, 1, NA)
...
if (exists("venglazenmaker_leefgebied_opp") && !all(is.na(terra::values(venglazenmaker_leefgebied_opp, mat = FALSE)))) {
  werkelijk_export_rast <- terra::ifel(!is.na(venglazenmaker_leefgebied_opp) & venglazenmaker_leefgebied_opp > 0, 1, NA)
...
if (exists("venglazenmaker_arpl_opp") && !all(is.na(terra::values(venglazenmaker_arpl_opp, mat = FALSE)))) {
  arpl_export_rast <- terra::ifel(!is.na(venglazenmaker_arpl_opp) & venglazenmaker_arpl_opp > 0, 1, NA)
} else {
...
if (exists("venglazenmaker_verspr_opp") && !all(is.na(terra::values(venglazenmaker_verspr_opp, mat = FALSE)))) {
  verspreiding_export_rast <- terra::ifel(!is.na(venglazenmaker_verspr_opp) & venglazenmaker_verspr_opp > 0, 1, NA)
} else {
...
for(item in export_config) {
  ...
  message(paste("    [OK] Geëxporteerd naadschijf:", basename(file_path)))
}
