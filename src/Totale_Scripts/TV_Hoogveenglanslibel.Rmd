...
```{r export}
# ==============================================================================
# SCHONE BINAIR EXPORT ZONDER VALSE NULLEN (HOOGVEENGLANSLIBEL)
# ==============================================================================
message("-> Start geformatteerde binaire export voor hoogveenglanslibel...")
...
# 1. Maximale potentie
if (exists("hoogveenglanslibel_leefgebied_max") && !all(is.na(terra::values(hoogveenglanslibel_leefgebied_max, mat = FALSE)))) {
  potentie_export_rast <- terra::ifel(!is.na(hoogveenglanslibel_leefgebied_max) & hoogveenglanslibel_leefgebied_max > 0, 1, NA)
...
if (exists("hoogveenglanslibel_leefgebied_opp") && !all(is.na(terra::values(hoogveenglanslibel_leefgebied_opp, mat = FALSE)))) {
...
# 3. ARPL
if (exists("hoogveenglanslibel_arpl_opp") && !all(is.na(terra::values(hoogveenglanslibel_arpl_opp, mat = FALSE)))) {
  arpl_export_rast <- terra::ifel(!is.na(hoogveenglanslibel_arpl_opp) & hoogveenglanslibel_arpl_opp > 0, 1, NA)
...
if (exists("hoogveenglanslibel_verspreiding_bin") && !all(is.na(terra::values(hoogveenglanslibel_verspreiding_bin, mat = FALSE)))) {
  verspreiding_export_rast <- terra::ifel(!is.na(hoogveenglanslibel_verspreiding_bin) & hoogveenglanslibel_verspreiding_bin > 0, 1, NA)
...
message("-> Alle GeoTIFF exports voor Hoogveenglanslibel zijn succesvol weggeschreven!")
```
