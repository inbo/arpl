...
waarnemingen_path <- here("data/input/Territoria_Soorten/MH_Territoria_ZwarteSpecht.csv")
...
# Maak een binaire mal van het Mechelse_Heide ZONDER de buffer
...
if (!all(is.na(terra::values(cl_max, mat=FALSE)))) {
  ...
  # 3. Welke clusters raken het Mechelse_Heide
