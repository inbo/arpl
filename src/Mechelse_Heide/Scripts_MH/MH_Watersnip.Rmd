...
waarnemingen_path <- here("data/input/Territoria_Soorten/MH_Territoria_Watersnip.csv")
...
# Binaire mal van het Mechelse_Heide ZONDER de buffer
...
if (!all(is.na(terra::values(cl_max, mat=FALSE)))) {
  ...
  # 3. Welke clusters raken Mechelse_Heide
