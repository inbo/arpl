...
# ==============================================================================
# WATERBIOTOOP VENWITSNUITLIBEL (Minimaal 100 m² - PARALLEL)
# ==============================================================================
...
# ==============================================================================
# RUIME OMGEVING & PERCENTAGE-CHECK (>60% BOS - PARALLEL)
# ==============================================================================
...
venwitsnuitlibel_land_ruim_max <- template_MH * NA
...
venwitsnuitlibel_land_ruim_opp <- template_MH * NA
...
venwitsnuitlibel_leefgebied_max <- terra::crop(venwitsnuitlibel_leefgebied_max, template_MH)
...
venwitsnuitlibel_leefgebied_opp <- terra::crop(venwitsnuitlibel_leefgebied_opp, template_MH)

# DEFINITIEVE MODELUITGANGEN
final_max <- venwitsnuitlibel_leefgebied_max
final_opp <- venwitsnuitlibel_leefgebied_opp
