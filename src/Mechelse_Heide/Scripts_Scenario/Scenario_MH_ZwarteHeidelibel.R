...
zwarteheidelibel_land_ruim_max <- template_MH * NA
...
zwarteheidelibel_land_ruim_opp <- template_MH * NA
...
zwarteheidelibel_leefgebied_max <- terra::crop(zwarteheidelibel_leefgebied_max, template_MH)
...
zwarteheidelibel_leefgebied_opp <- terra::crop(zwarteheidelibel_leefgebied_opp, template_MH)
