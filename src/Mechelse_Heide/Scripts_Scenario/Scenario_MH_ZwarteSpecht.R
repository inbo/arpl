...
# ==============================================================================
r_bos_groot_300ha_max <- template_MH * NA
r_bos_klein_50ha_max  <- template_MH * NA
...
r_bos_groot_300ha_opp <- template_MH * NA
r_bos_klein_50ha_opp  <- template_MH * NA
...
# --- SPOOR A: MAX ---
r_bos_klein_goedgekeurd_max <- template_MH * NA
...
# --- SPOOR B: OPP ---
r_bos_klein_goedgekeurd_opp <- template_MH * NA
...
zwartespecht_leefgebied_max <- terra::crop(finaal_leefgebied_clusters_max$raster, template_MH)
...
zwartespecht_leefgebied_opp <- terra::crop(finaal_leefgebied_clusters_opp$raster, template_MH)
