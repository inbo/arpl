...
profiel_sync      <- terra::crop(raw_profiel, template_MH) %>% terra::resample(template_MH, method = "near")
drainage_sync     <- terra::crop(raw_drainage, template_MH) %>% terra::resample(template_MH, method = "near")
overstroming_sync <- terra::crop(raw_overstroming, template_MH) %>% terra::resample(template_MH, method = "near")
...
f_matrix <- terra::focalMat(template_MH, d = 20, type = "circle")
