...
SCENARIO_RDS_PAD <- here("data/input/Scenario_rds/MH_Scenario_bosbehoudss_ss31fix_tvg_vrij_2026.rds")
...
OUTPUT_DIR       <- here("data/output/Mechelse_Heide/HTML_Rapporten_Scenario", HUIDIG_SCENARIO)
...
soorten_script_pad <- file.path(MAP_SCRIPTS, "Scenario_MH_Leefgebieden_Simpel.Rmd")
