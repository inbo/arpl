...
if (!is.null(cl_foerageer_max) && !all(is.na(terra::values(cl_foerageer_max, mat = FALSE)))) {
  max_id_voortplanting <- 0
  if (!is.null(cl_voortplanting_max) && !all(is.na(terra::values(cl_voortplanting_max, mat = FALSE)))) {
...
if (!is.null(cl_foerageer_opp) && !all(is.na(terra::values(cl_foerageer_opp, mat = FALSE)))) {
  max_id_voortplanting_opp <- 0
  if (!is.null(cl_voortplanting_opp) && !all(is.na(terra::values(cl_voortplanting_opp, mat = FALSE)))) {
