...
grotezilverreiger_leefgebied_max <- terra::mask(finaal_reiger_max, r_watervogelgebied_max) %>% terra::crop(template_TV)
grotezilverreiger_leefgebied_opp <- terra::mask(finaal_reiger_opp, r_watervogelgebied_max) %>% terra::crop(template_TV)
