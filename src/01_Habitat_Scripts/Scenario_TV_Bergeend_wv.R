...
# ==============================================================================
# STAP 3: 50M CLUSTERING (5 HA) EN INTERSECTIE MET TELGEBIEDEN (PARALLEL)
# ==============================================================================
...
# --- SPOOR B: OPP (Volledig autonoom en parallel) ---
...
message("--- BERGEEND MODEL SUCCESVOL AFGEROND ---")
cat("Totaal werkelijk habitat Bergeend binnen regio (ha):", round(calc_ha_exact(bergeend_leefgebied_opp), 2), "\n")
