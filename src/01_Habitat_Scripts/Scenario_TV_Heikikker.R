...
waterbiotoop_bwk_max <- if (!is.na(w_key)) lijst_matches[[w_key]] else template_TV * NA
waterbiotoop_bwk_opp <- if (!is.na(w_key)) lijst_oppervlaktes[[w_key]] else template_TV * NA
landbiotoop_bwk_max  <- if (!is.na(l_key)) lijst_matches[[l_key]] else template_TV * NA
landbiotoop_bwk_opp  <- if (!is.na(l_key)) lijst_oppervlaktes[[l_key]] else template_TV * NA
...
# --- SPOOR MAX ---
if (!is.null(heikikker_land_gefilterd_max) && !all(is.na(terra::values(heikikker_land_gefilterd_max, mat = FALSE))) && 
    !is.null(r_heikikker_waterbiotoop1) && !all(is.na(terra::values(r_heikikker_waterbiotoop1, mat = FALSE)))) {
...
# --- SPOOR OPP ---
if (!is.null(heikikker_land_gefilterd_opp) && !all(is.na(terra::values(heikikker_land_gefilterd_opp, mat = FALSE))) && 
    !is.null(r_heikikker_waterbiotoop1_opp) && !all(is.na(terra::values(r_heikikker_waterbiotoop1_opp, mat = FALSE)))) {
