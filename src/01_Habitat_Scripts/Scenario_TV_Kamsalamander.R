...
# --- SPOOR MAX ---
if (!is.null(kamsalamander_land_gefilterd_max) && !all(is.na(terra::values(kamsalamander_land_gefilterd_max, mat = FALSE))) && 
    !is.null(r_kamsalamander_waterbiotoop1) && !all(is.na(terra::values(r_kamsalamander_waterbiotoop1, mat = FALSE)))) {
...
# --- SPOOR OPP ---
if (!is.null(kamsalamander_land_gefilterd_opp) && !all(is.na(terra::values(kamsalamander_land_gefilterd_opp, mat = FALSE))) && 
    !is.null(r_kamsalamander_waterbiotoop1_opp) && !all(is.na(terra::values(r_kamsalamander_waterbiotoop1_opp, mat = FALSE)))) {
...
if (!all(is.na(terra::values(cl_netwerk_opp, mat = FALSE)))) {
  ...
  if (length(na.omit(valid_ids_opp)) > 0) {
    kamsalamander_leefgebied_opp <- terra::mask(heikikker_leefgebied1_opp, cl_netwerk_opp %in% valid_ids_opp)
