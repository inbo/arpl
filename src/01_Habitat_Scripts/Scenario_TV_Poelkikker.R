...
# --- SPOOR MAX ---
if (!is.null(poelkikker_land_gefilterd_max) && !all(is.na(terra::values(poelkikker_land_gefilterd_max, mat = FALSE))) && 
    !is.null(r_poelkikker_waterbiotoop1) && !all(is.na(terra::values(r_poelkikker_waterbiotoop1, mat = FALSE)))) {
...
# --- SPOOR OPP ---
if (!is.null(poelkikker_land_gefilterd_opp) && !all(is.na(terra::values(poelkikker_land_gefilterd_opp, mat = FALSE))) && 
    !is.null(r_poelkikker_waterbiotoop1_opp) && !all(is.na(terra::values(r_poelkikker_waterbiotoop1_opp, mat = FALSE)))) {
