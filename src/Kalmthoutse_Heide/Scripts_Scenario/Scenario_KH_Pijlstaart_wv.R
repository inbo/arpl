...
# Maak een masker op basis van template_KH waarbij alle geldige cellen de waarde 1 krijgen
r_watervogelgebied_max <- terra::ifel(!is.na(template_KH), 1, NA)
...
pijlstaart_leefgebied_max <- terra::mask(r_foer_5ha_max, r_watervogelgebied_max) %>% terra::crop(template_KH)
pijlstaart_leefgebied_opp <- terra::mask(r_foer_5ha_opp, r_watervogelgebied_max) %>% terra::crop(template_KH)
