...
message("-> Ruimtelijke koppeling land- en waterbiotoop (AfstandBiotopen = 0 m + 10m oeverkoppeling) voor MAX en OPP parallel...")

# --- SPOOR MAX ---
if (!is.null(poelkikker_land_gefilterd_max) && !all(is.na(suppressWarnings(terra::minmax(poelkikker_land_gefilterd_max)))) && 
    !is.null(r_poelkikker_waterbiotoop1) && !all(is.na(suppressWarnings(terra::minmax(r_poelkikker_waterbiotoop1))))) {
...
# --- SPOOR OPP ---
if (!is.null(poelkikker_land_gefilterd_opp) && !all(is.na(suppressWarnings(terra::minmax(poelkikker_land_gefilterd_opp)))) && 
    !is.null(r_poelkikker_waterbiotoop1_opp) && !all(is.na(suppressWarnings(terra::minmax(r_poelkikker_waterbiotoop1_opp))))) {
