...
r_grb      <- terra::resample(r_grb_raw, id_raster_KH, method = "near") %>% terra::crop(id_raster_KH)
...
# ==============================================================================
watersnip_leefgebied_max <- template_KH * NA
watersnip_leefgebied_opp <- template_KH * NA
...
final_max <- watersnip_leefgebied_max %>% terra::crop(template_KH)
final_opp <- watersnip_leefgebied_opp %>% terra::crop(template_KH)
