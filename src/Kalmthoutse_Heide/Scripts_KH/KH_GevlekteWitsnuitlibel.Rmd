...
final_max_layer <- if(exists("leefgebied_max")) leefgebied_max else template_KH * NA
final_opp_layer <- if(exists("leefgebied_opp")) leefgebied_opp else template_KH * NA
