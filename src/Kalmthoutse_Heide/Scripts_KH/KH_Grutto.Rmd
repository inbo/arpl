...
waarnemingen_path <- here("data/input/Territoria_Soorten/KH_Territoria_Grutto.csv")
...
get_classified_netwerk_stats <- function(res_strikt) {
  ...
  # 3. Maak een binaire raster-masker van de Kalmthoutse Heide grens (1 = Binnen KH, NA = Buiten KH)
  ...
  # 4. Bepaal welke unieke Netwerk-IDs minstens 1 pixel BINNEN het KH-gebied hebben liggen
  ...
  # Binnen KH: Al het habitat van netwerken die (deels) binnen KH liggen
  ...
  # Buiten KH: Al het habitat van netwerken die volledig buiten KH liggen
...
grutto_audit_tabel %>% 
  knitr::kable(caption = "Gevalideerde verdeling van Grutto-netwerken (Berekend op pixel-overlap met KH-grens)") %>% 
