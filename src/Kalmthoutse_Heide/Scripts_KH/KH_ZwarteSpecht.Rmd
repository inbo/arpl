...
waarnemingen_path <- here("data/input/Territoria_Soorten/KH_Territoria_ZwarteSpecht.csv")
...
# Maak een binaire mal van het Kalmthoutse_Heide ZONDER de buffer
...
if (!all(is.na(terra::values(cl_max, mat=FALSE)))) {
  ...
  # 3. Welke clusters raken het Kalmthoutse_Heide
